...
CREATE INDEX IF NOT EXISTS idx_news_search ON news USING gin(to_tsvector('english', title || ' ' || excerpt));

-- Enable Row Level Security (optional)
ALTER TABLE news ENABLE ROW LEVEL SECURITY;

-- Create policy for public read access
CREATE POLICY IF NOT EXISTS "Public can read news" ON news
